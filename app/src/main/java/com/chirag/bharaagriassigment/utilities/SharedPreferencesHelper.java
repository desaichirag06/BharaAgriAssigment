...
public class SharedPreferencesHelper {
    ...
    private static final String PREF_DEFAULT_LIST = "Pref Default List";
    ...
    public void saveDefaultList(boolean isTopRatedSelected) {
        prefs.edit().putBoolean(PREF_DEFAULT_LIST, isTopRatedSelected).apply();
    }

    public boolean getDefaultList() {
        return prefs.getBoolean(PREF_DEFAULT_LIST, false);
    }
